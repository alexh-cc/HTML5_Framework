...
var ConsoleLogViewer = (function() {
	...
	ConsoleLogViewer.prototype.log = function(args, color, splitArgs)
	{
        ...
        this.panel.innerHTML = _items.join("<br>");
	}


    ConsoleLogViewer.prototype.clear = function()
    {
        if (!ConsoleLogViewer.logEnabled) return;
	...
	{
		//var self = this;
        var alignment = "bottom-aligned";//window.location.href.indexOf("console_at_bottom=true") > -1 || window.location.href.indexOf("console_at_bottom=1") > -1 ? "bottom-aligned" : "top-aligned";
		var div = document.createElement('div');
		div.id = "debug_console";
		div.className = alignment;
		div.innerHTML = ('<a href="#close" id="debug_console_close_button" class="log-button">x</a><a href="#position" id="debug_console_position_button" class="log-button">&#8597;</a><a href="#pause" id="debug_console_pause_button" class="log-button">&#9658;</a><a href="#clear" id="debug_console_clear_button" class="log-button">0</a><div id="debug_console_messages"></div>');
		document.getElementsByTagName('body')[0].appendChild(div);

        self.panel = document.getElementById('debug_console_messages');
        ...
        document.getElementById("debug_console_clear_button").addEventListener("click", function(e) {
            self.clear();
            e.preventDefault();
        }, false);
	}
...
game_shell.logViewer = new ConsoleLogViewer();