/**
 * Customised version of dragonBones
 * fixes glitches when changing timelines
 * v1.0.0
 */
...
(function (dragonBones) {
    ...
    (function (animation) {
        ...
        var TimelineState = (function () {
            ...
            TimelineState.prototype.fadeIn = function (bone, animationState, timeline) {
                ...
                switch (this._timeline.getFrameList().length) {
                    case 0:
                        didChange = this._bone._arriveAtFrame(null, this, this._animationState, false);
                        this._updateState = 0;
                        break;
                    case 1:
                        this._updateState = -1;
                ...
                if (this._updateState) {
                    if (this._updateState > 0) {
                        ...
                        while (!this._currentFrame || playedTime > this._currentFramePosition + this._currentFrameDuration || playedTime < this._currentFramePosition) {
                            if (isArrivedFrame) {
                                didChange = this._bone._arriveAtFrame(this._currentFrame, this, this._animationState, true);
                            }
                            isArrivedFrame = true;
                        ...
                        if (isArrivedFrame) {
                            ...
                            didChange = this._bone._arriveAtFrame(this._currentFrame, this, this._animationState, false);
                        }
        ...
        var AnimationState = (function () {
            ...
            AnimationState.prototype.advanceTime = function (passedTime) {
                ...
                if (this.isPlaying && !this.isComplete) {
                    ...
                    var didChange = false;
                    for (var index in this._timelineStates) {
                        if((this._timelineStates[index]).update(progress)){
                            didChange = true;
                        }
                    }
                    if(didChange){
            ...
            AnimationState.prototype.addTimelineState = function (timelineName) {
                ...
                if (bone) {
                    ...
                    timelineState.fadeIn(bone, this, timeline);//TODO - if this causes removeDisplay then store reference for clearing later
        ...
        var Animation = (function () {
            ...
            Animation.prototype.gotoAndStop = function(animationName){
                this.gotoAndPlay(animationName, -1, -1, NaN, 0, null, Animation.NONE);

                this.advanceTime(0.00001);
            ...
            Animation.prototype.advanceTime = function (passedTime) {
                    ...
                    while (i--) {
                        ...
                        for (j = 0; j < stateListLength; j++) {
                            ...
                            if (k === l) {
                                ...
                                if(animationState.didChange){
                                    didChange = true;
                                    animationState.didChange = false;
                                }
                            }
                ...
                //now refresh if didChange
                if(didChange){
                    // - find bones that need to clear
                    k = this._armature._boneList.length;
                    var slot;
                    while (k--) {
                        bone = this._armature._boneList[k];
                        slot = bone.slot;
                        if(slot && slot.shouldRemoveDisplay){
                            slot.removeDisplay();
                        }
                    }
                }
    ...
    var Slot = (function (_super) {
        ...
        function Slot(displayBrideg) {
            ...
            this.shouldRemoveDisplay = false;
        ...
        Slot.prototype._setDisplay = function (display) {
            ...
            this._isDisplayOnStage =  (!this._isHideDisplay && this._displayBridge.getDisplay());
        };

        Slot.prototype.removeDisplay = function () {
            this.shouldRemoveDisplay = false;
        ...
        Slot.prototype._changeDisplay = function (displayIndex) {
            ...
            if (displayIndex < 0) {
                if (!this._isHideDisplay) {
                    ...
                    //only remove the first time this is called!
                    if(!this.didInit){
                        this._displayBridge.removeDisplay();
                        this.didInit = true;
                    }

                    this.shouldRemoveDisplay = true;
                    this.updateChildArmatureAnimation();
                }
            } else {
                if (this._isHideDisplay) {
    ...
    var Bone = (function (_super) {
        ...
        Object.defineProperty (Bone.prototype,'shouldRemoveDisplay', {
            get: function(){
                return this.slot.shouldRemoveDisplay;
            }
        });
        ...
        Bone.prototype._arriveAtFrame = function (frame, timelineState, animationState, isCross) {
            ...
            if (frame) {
                ...
                if (animationState.displayControl && (mixingType === 2 || mixingType === -1)) {
                    if (!this.displayController || this.displayController === animationState.name) {
                        ...
                        if (this.slot) {
                            ...
                            didChange = this.slot._changeDisplay(displayIndex);
                ...
                if (this.slot) {
                    didChange = this.slot._changeDisplay(-1);
                }
            }
            return didChange;
        };
